...
%token TOKEN_STATUS   // Status Register
%token TOKEN_HANDLER   // Handler Register
%token TOKEN_CAUSE   // Cause Register
...
instr
	...
	| TOKEN_CSRRD TOKEN_STATUS TOKEN_COMMA TOKEN_REG | TOKEN_CSRRD TOKEN_HANDLER TOKEN_COMMA TOKEN_REG | TOKEN_CSRRD TOKEN_CAUSE TOKEN_COMMA TOKEN_REG
